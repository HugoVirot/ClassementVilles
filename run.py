...
from apps.doctors.controllers import insert_doctors_into_db
from apps.doctors.controllers import calculate_ratio
from apps.doctors.models import create_doctors_table
...
if __name__ == "__main__":
    ...
    if args.action == "rank_cities_by_note":
        ...
        sorted_by_rating_cities = rate_and_sort_biggest_cities(highschools_data,
                                                               sorted_cities)  # noter et trier par note
